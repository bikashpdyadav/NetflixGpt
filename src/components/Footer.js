...
const Footer = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-8 px-4 sm:px-8 lg:px-16 mb-8 lg:mb-0">
      <div className="flex flex-row gap-12 flex-wrap justify-center lg:justify-start">
        <div className="flex flex-col flex-1 min-w-[150px] xs:text-center lg:text-left">
