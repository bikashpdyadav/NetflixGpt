...
const TopContainer = () => {
  ...
  return (
    <div className="w-full p-4 lg:ml-4 flex items-center justify-center flex-wrap xs:gap-4 lg:justify-between bg-gradient-to-r from-black via-gray-700 to-gray-900 text-white">
